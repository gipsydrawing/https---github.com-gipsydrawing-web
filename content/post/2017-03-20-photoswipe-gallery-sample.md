...
{{< gallery caption-effect="fade" >}}
  {{< figure thumb="-thumb" link="/img/logo.jpg" caption="logo" >}}
  {{< figure thumb="-thumb" link="/img/samurai.jpg" caption="samurai" >}}
...
- `{{</* figure src="logo.jpg" */>}}` will use `logo.jpg` for thumbnail and lightbox
